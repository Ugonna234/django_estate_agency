...
SECRET_KEY = 'django-insecure-vy840uqp&q022aty8el5##_4qe0hbn5g^njz7)10%)8^e^#b%4'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'estate/static') #telling it how to locate our own static file
]
